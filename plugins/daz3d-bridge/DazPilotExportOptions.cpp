...
DazPilotExportOptions DazPilotExportOptions::fromJson(const QString& jsonStr) {
    DazPilotExportOptions opts;
    try {
...
void DazPilotExportOptions::applyToSettings(DzFileIOSettings* settings) const {
    if (!settings) return;
