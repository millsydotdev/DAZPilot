...
#[tauri::command]
fn install_daz3d_plugin() -> Result<String, String> {
    ...
    // Try common Daz Studio install locations
    let daz_candidates = [
    ...
    let daz_plugins_path = daz_candidates
        .iter()
...
#[tauri::command]
fn get_plugin_status() -> Result<String, String> {
    let daz_candidates = [
