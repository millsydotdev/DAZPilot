...
impl SceneKnowledgeBase {
    ...
    fn init_scene_templates(&mut self) {
        // Portrait scene
        self.scene_templates.insert(SceneType::Portrait, SceneTemplate {
        ...
        // Full body scene
        self.scene_templates.insert(SceneType::FullBody, SceneTemplate {
        ...
        // Action scene
        self.scene_templates.insert(SceneType::Action, SceneTemplate {
            ...
            lighting_setup: vec![
                LightingRecommendation {
                    ...
                    intensity_range: (0.8, 1.2),
                    position_hint: "Low angle, 30 degrees left, highlighting muscles".to_string(),
                },
                LightingRecommendation {
                    light_type: "spot_light".to_string(),
                    purpose: "rim".to_string(),
        ...
        // Fantasy scene
        self.scene_templates.insert(SceneType::Fantasy, SceneTemplate {
            scene_type: SceneType::Fantasy,
            description: "A fantastical scene with magical or otherworldly elements".to_string(),
            lighting_setup: vec![
                LightingRecommendation {
                    light_type: "point_light".to_string(),
                    purpose: "key".to_string(),
        ...
        // Sci-Fi scene
        self.scene_templates.insert(SceneType::SciFi, SceneTemplate {
            ...
            lighting_setup: vec![
                LightingRecommendation {
                    ...
                    intensity_range: (0.6, 0.9),
                    position_hint: "High angle, 30 degrees left, creating sharp shadows".to_string(),
                },
                LightingRecommendation {
                    light_type: "area_light".to_string(),
                    purpose: "fill".to_string(),
        ...
        // Casual scene
        self.scene_templates.insert(SceneType::Casual, SceneTemplate {
            ...
            lighting_setup: vec![
                ...
                LightingRecommendation {
                    ...
                    color: "255,255,255".to_string(),
                    intensity_range: (0.1, 0.2),
                    position_hint: "Very weak fill just to prevent pure black shadows".to_string(),
                },
            ],
            composition_guidelines: vec![
        ...
        // Formal scene
        self.scene_templates.insert(SceneType::Formal, SceneTemplate {
        ...
        // Product render
        self.scene_templates.insert(SceneType::ProductRender, SceneTemplate {
            ...
            recommended_figures: vec![],
            recommended_assets: vec![
                "the asset being rendered".to_string(),
            ],
            common_poses: vec![],
            common_mistakes: vec![
        ...
        // Animation test
        self.scene_templates.insert(SceneType::AnimationTest, SceneTemplate {
    ...
    pub fn get_scene_understanding(&self, scene_type: SceneType) -> Option<SceneUnderstanding> {
        self.scene_templates.get(&scene_type).map(|template| SceneUnderstanding {
    ...
    pub fn infer_scene_type(&self, input: &str) -> Option<SceneType> {
        ...
        if lower.contains("full body") || lower.contains("fullbody") || lower.contains("head to toe") {
            return Some(SceneType::FullBody);
        }
        if lower.contains("action") || lower.contains("fight") || lower.contains("combat") || 
           lower.contains("running") || lower.contains("jumping") || lower.contains("dynamic") {
            return Some(SceneType::Action);
        }
        if lower.contains("fantasy") || lower.contains("magical") || lower.contains("elf") || 
           lower.contains("wizard") || lower.contains("fairy") {
            return Some(SceneType::Fantasy);
        }
        if lower.contains("sci-fi") || lower.contains("scifi") || lower.contains("futuristic") || 
           lower.contains("cyberpunk") || lower.contains("space") || lower.contains("robot") {
            return Some(SceneType::SciFi);
        }
        if lower.contains("casual") || lower.contains("everyday") || lower.contains("relaxed") ||
           lower.contains("lounge") || lower.contains("hanging out") {
            return Some(SceneType::Casual);
        }
        if lower.contains("formal") || lower.contains("gala") || lower.contains("red carpet") ||
           lower.contains("evening gown") || lower.contains("tuxedo") {
