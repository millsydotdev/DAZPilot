use dazpilot_lib::vision_service::{BoundingBox, generate_spatial_relationships};
...
fn test_world_space_bounding_box_directions() {
    ...
    assert!(
        relationships.contains("'Genesis 8 Female' is to the right of and in front of and above 'Desk'"),
